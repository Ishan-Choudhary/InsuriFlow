...
export namespace Prisma {
  ...
  */
  ...
  export type PolicyAvgAggregateOutputType = {
    id: number | null
    annualDeductible: Decimal | null
    deductibleRemaining: Decimal | null
    outOfPocketMax: Decimal | null
    userId: number | null
  }
  ...
  export type $PolicyPayload<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    ...
    scalars: $Extensions.GetPayloadResult<{
      ...
      policyNumber: string
      coverageDetails: string
      annualDeductible: Prisma.Decimal
      deductibleRemaining: Prisma.Decimal
      outOfPocketMax: Prisma.Decimal
      startDate: Date
      endDate: Date
      createdAt: Date
      updatedAt: Date
  ...
  interface PolicyFieldRefs {
    ...
    readonly annualDeductible: FieldRef<"Policy", 'Decimal'>
    readonly deductibleRemaining: FieldRef<"Policy", 'Decimal'>
    readonly outOfPocketMax: FieldRef<"Policy", 'Decimal'>
  ...
  export type PolicyWhereInput = {
    ...
    annualDeductible?: DecimalFilter<"Policy"> | Decimal | DecimalJsLike | number | string
    deductibleRemaining?: DecimalFilter<"Policy"> | Decimal | DecimalJsLike | number | string
    outOfPocketMax?: DecimalFilter<"Policy"> | Decimal | DecimalJsLike | number | string
  ...
  export type PolicyScalarWhereWithAggregatesInput = {
    ...
    annualDeductible?: DecimalWithAggregatesFilter<"Policy"> | Decimal | DecimalJsLike | number | string
    deductibleRemaining?: DecimalWithAggregatesFilter<"Policy"> | Decimal | DecimalJsLike | number | string
    outOfPocketMax?: DecimalWithAggregatesFilter<"Policy"> | Decimal | DecimalJsLike | number | string
